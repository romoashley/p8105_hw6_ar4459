...
Using the quantile function, I calculate the 95% confidence interval for
...
A lower rmse indicates a better model. According the plot, the best
model is model_two since it had the lowest rmse value.
